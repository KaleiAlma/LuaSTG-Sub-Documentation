...
---@field timer integer
---
--- **Warning:** Has been removed from latest main-line versions of LuaSTG Sub.  
--- You may re-enable this behavior by defining LUASTG_ENABLE_GAME_OBJECT_PROPERTY_PAUSE
--- during engine compilation (Config.h).  
--- This property is still not recommended, as it is confusing to use.
---
