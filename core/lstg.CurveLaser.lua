...
---
--- Deprecated in LuaSTG Sub v0.20.11.
--- Please use `CollisionCheckWithWidth` instead.
---@param x number
---@param y number
---@param rot number
---@param a number
...
--- Same as `CollisionCheck`, but with an additional laser width parameter.  
--- Also supports passing in a `lstg.GameObject` to provide non-`width` parameters.
---
--- Added in LuaSTG Sub v0.20.11.
---@param width number
---@param x number
---@param y number
---@param rot number
